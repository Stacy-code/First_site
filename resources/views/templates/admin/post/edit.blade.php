...
@section('content')
    ...
    <form class="col-lg-4" method="post" action="{{ route('admin.post.update',$callback->id) }}" >
        @method('PATCH')
        @csrf
        <div class="form-group " >
            <label for="name">Name</label>
            <input type="text" class="form-control" name="name" id="name" aria-describedby="emailHelp" value="{{ $callback->name }}">
        </div>
        <div class="form-group">
